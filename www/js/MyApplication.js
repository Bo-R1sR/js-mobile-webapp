    ...
    async oncreate() {
        ...
        function checkAvailability (bool) {
            if ( bool)
            {
                ...
                //document.getElementById("switchCRUD").disabled="false";
                document.getElementById("switchCRUD").style.opacity="1.0";
            }
            else
            {
                console.log("Server returned false");
                document.getElementById("switchCRUD").disabled="true";
            }
        }

        mwfUtils.isWebserverAvailable(checkAvailability);
